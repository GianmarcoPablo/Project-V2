...
interface IGetAllAdvertisementsJobUseCase {
    execute(body: PaginationJobsDto): Promise<{ currentPage: number; totalPages: number; totalJobs: number; advertisementsJobs: AdvertisementJob[] }>
}
...
export class GetAllAdvertisementsJobUseCase implements IGetAllAdvertisementsJobUseCase {
    ...
    async execute(body: PaginationJobsDto): Promise<{ currentPage: number; totalPages: number; totalJobs: number; advertisementsJobs: AdvertisementJob[] }> {
